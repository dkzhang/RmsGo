...
type QueryTreeReply struct {
	...
	NodesNum             string   `protobuf:"bytes,2,opt,name=nodesNum,proto3" json:"nodesNum,omitempty"`
...
func (m *QueryTreeReply) GetNodesNum() string {
	if m != nil {
		return m.NodesNum
	}
	return ""
...
var fileDescriptor_1900065f61297778 = []byte{
	...
	,
}
